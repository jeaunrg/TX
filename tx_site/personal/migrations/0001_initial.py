    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("rate", models.FloatField(default=0.00024000000000000003)),
            ],
        ),
        migrations.CreateModel(
            name="Base",
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="salaire",
                        through="personal.Liaison",
                        to="personal.element",
                    ),
                ),
                (
                    "elements_imposable",
                    models.ManyToManyField(
                        related_name="imposable",
                        through="personal.LiaisonImposable",
                        to="personal.elementimposable",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            model_name="liaisonimposable",
            name="salaire",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="personal.salaire"
            ),
        ),
        migrations.AddField(
            model_name="liaison",
        ...
        migrations.AddField(
            model_name="elementimposable",
            name="net_avant_impot",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="_elements_imposable",
                to="personal.salaire",
            ),
        ),
        migrations.AddField(
